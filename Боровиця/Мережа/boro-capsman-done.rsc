# 2026-06-08 15:53:27 by RouterOS 7.22.1
# software id = Y7AP-1H76
#
# model = L41G-2axD
# serial number = HES09AY188T
/caps-man channel
add band=2ghz-b/g/n frequency=2412 name=ch-2g-1
add band=2ghz-b/g/n frequency=2437 name=ch-2g-6
add band=2ghz-b/g/n frequency=2462 name=ch-2g-11
add band=5ghz-a/n/ac extension-channel=Ceee frequency=5180 name=ch-5g-36
add band=5ghz-a/n/ac extension-channel=eeCe frequency=5220 name=ch-5g-44
add band=5ghz-a/n/ac extension-channel=eeeC frequency=5240 name=ch-5g-48
/caps-man datapath
add local-forwarding=yes name=dp-fubar vlan-id=20 vlan-mode=use-tag
add local-forwarding=yes name=dp-guest vlan-id=50 vlan-mode=use-tag
/interface bridge
...
add channel.band=2ghz-ax .skip-dfs-channels=10min-cac .width=20/40mhz \
    configuration.country=Ukraine .mode=ap .ssid=Fubar radio-mac=\
    78:9A:18:19:AF:B0 security.authentication-types=wpa2-psk,wpa3-psk \
    .connect-priority=0
...
/caps-man security
add authentication-types=wpa2-psk encryption=aes-ccm name=sec-fubar
add authentication-types=wpa2-psk encryption=aes-ccm name=sec-guest
/caps-man configuration
add country=ukraine datapath=dp-guest name=cfg-guest security=sec-guest ssid=\
    Chinazes
add channel=ch-2g-6 country=ukraine datapath=dp-fubar name=cfg-fubar-2g-cap1 \
    security=sec-fubar ssid=Fubar
add channel=ch-2g-1 country=ukraine datapath=dp-fubar name=cfg-fubar-2g-cap2 \
    security=sec-fubar ssid=Fubar
add channel=ch-2g-11 country=ukraine datapath=dp-fubar name=cfg-fubar-2g-wap \
    security=sec-fubar ssid=Fubar
add channel=ch-5g-44 country=ukraine datapath=dp-fubar name=cfg-fubar-5g-cap1 \
    security=sec-fubar ssid=Fubar
add channel=ch-5g-36 country=ukraine datapath=dp-fubar name=cfg-fubar-5g-cap2 \
    security=sec-fubar ssid=Fubar
add channel=ch-5g-48 country=ukraine datapath=dp-fubar name=cfg-fubar-5g-wap \
    security=sec-fubar ssid=Fubar
/interface list
...
add action=create-dynamic-enabled master-configuration=cfg-fubar-2g-wap \
    radio-mac=CC:2D:E0:85:BE:71 slave-configurations=cfg-guest
add action=create-dynamic-enabled master-configuration=cfg-fubar-5g-wap \
    radio-mac=CC:2D:E0:85:BE:70 slave-configurations=cfg-guest
add action=create-dynamic-enabled master-configuration=cfg-fubar-2g-cap2 \
    radio-mac=CC:2D:E0:ED:1A:3A slave-configurations=cfg-guest
add action=create-dynamic-enabled master-configuration=cfg-fubar-5g-cap2 \
    radio-mac=CC:2D:E0:ED:1A:3B slave-configurations=cfg-guest
add action=create-dynamic-enabled master-configuration=cfg-fubar-2g-cap1 \
    radio-mac=CC:2D:E0:ED:18:46 slave-configurations=cfg-guest
add action=create-dynamic-enabled master-configuration=cfg-fubar-5g-cap1 \
    radio-mac=CC:2D:E0:ED:18:47 slave-configurations=cfg-guest
