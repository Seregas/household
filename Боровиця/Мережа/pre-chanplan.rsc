# 2026-06-08 15:49:44 by RouterOS 7.22.1
# software id = Y7AP-1H76
#
# model = L41G-2axD
# serial number = HES09AY188T
/caps-man channel
add band=2ghz-b/g/n frequency=2412,2437,2462 name=ch-2g
add band=5ghz-a/n/ac frequency=5180,5220,5240 name=ch-5g
/caps-man datapath
...
add channel=ch-2g country=ukraine datapath=dp-fubar name=cfg-fubar-2g \
    security=sec-fubar ssid=Fubar
add channel=ch-5g country=ukraine datapath=dp-fubar name=cfg-fubar-5g \
    security=sec-fubar ssid=Fubar
...
add action=create-dynamic-enabled master-configuration=cfg-fubar-2g \
    radio-mac=CC:2D:E0:85:BE:71 slave-configurations=cfg-guest
add action=create-dynamic-enabled master-configuration=cfg-fubar-5g \
