...
/interface wireless
set wlan1 disabled=no mode=ap-bridge band=2ghz-b/g/n channel-width=20mhz frequency=2462 ssid=Fubar security-profile=sp-fubar country=ukraine
...
/interface bridge vlan add bridge=bridge vlan-ids=10 tagged=ether1,bridge
/interface bridge vlan add bridge=bridge vlan-ids=20 tagged=ether1 untagged=wlan1,wlan2
/interface bridge vlan add bridge=bridge vlan-ids=50 tagged=ether1 untagged=wlan-guest24,wlan-guest5
