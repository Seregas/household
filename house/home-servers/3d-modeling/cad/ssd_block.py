        ...
        for (ax0, ax1), (fx0_, fx1_), (lz0, lz1), by0_ in (
            ...
            if lz1 > 12.0:                     # лівий гачок (верхній шар)
                ...
                with Locations(((fx0_ + fx1_) / 2,
                    ...
                    Box(fx1_ - fx0_, by1_ - (rear_f - 0.05), 8.9 - 3.0,
                        align=AMIN)
            ...
            with Locations(((fx0_ + fx1_) / 2,
                ...
                Box(fx1_ - fx0_, P.SNAP_TOOTH_D,
                    ...
                    align=AMIN)
            # (в4.5: ПОЛИЧКИ видалені — тест-друк: чіплялись за гребінь
            # бортика і відтискали стопу від грані; вертикаль тепер на
            # балках 1.3×2.2 — ~4-5Н пружно на гачок, зуб лишається в
            # пазу)
