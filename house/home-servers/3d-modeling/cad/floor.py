...
def plan_geometry():
    ...
    # 27.07 (варіант А): + фестони — інакше наскрізна tri-кишеня могла б
    # пробити 1.5-смугу мембрани над мостом соти (кишені йдуть лише 0.5
    # від сот, а фестон — 1.5)
    ...
    for i in range(SKIRT_N):
        ...
        ft = fp.intersection(translate(fp, yoff=d)) if i else fp
