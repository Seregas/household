...
Деталі:
  • test_tray  — шматок дна зі слотами SNAP-сітки (колонки 122.8/130.6,
    ряди 8/38/68) + підмембранні кишені + смужка правої стінки
    (X 114..137.95, Y −1..75, Z 0..12).
  • test_block — SSD-блок, зрізаний по Z8.6: слаб з обома кишенями
    зачепів (передня з козирком Y3.95, задня Y68) і виїмками crush.
...
if __name__ == "__main__":
    ...
    # 20.07: зона снап-сітки — ряди 8/38/68 обох колонок; верх 12
    ...
    blk = ssd_block.build()
    # 20.07: зріз по Z8.6 — слаб (3..8) з кишенями зачепів (стеля 7.35)
