...
Лишаються дрібні прецедентні консолі: уступ клин-бампа 1.2 на h0.45
(2-3 шари; прецедент — губа панелі 1.15) і губка t0.65 ~1.1 на h0.75;
...
def build():
    ...
    with BuildPart() as ins:
        ...
        # рампа 45° від (−98.15, ztop_f) до (−96.95, ztop_f+1.2)
        # тре по стелі фальца, прямий уступ на INS_BUMP_YC клацає в
        # кишеню панелі (зачеплення за стелю 51.7 = 1.0); база
        # втоплена 0.4 у язичок (чистий fuse, не butt-стик).
        # У друці ТИЛОМ вниз уступ = консоль 1.2 на h0.45 (2-3 шари
