        ...
        for xc in P.INS_DIMPLE_XC:
            with Locations((xc, (-98.35 + -96.9) / 2,
                ...
                Box(P.INS_LIP_TAB_W + 1.0, -96.9 - -98.35, 52.9 - 51.0,
                    mode=Mode.SUBTRACT)
        # (23.07: ГУБИ ФАЛЬЦА 22.07 ВИДАЛЕНІ — «додає нависань,
        # складності; знизу зуби панелі тримають і так»: проти
        # вдавлення знизу працюють жорсткі язички в кишенях фальца,
        # згори — клин-бампи в кишенях стелі)
