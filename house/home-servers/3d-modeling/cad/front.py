...
def plan_panel():
    ...
    # зліва — до внутрішньої грані ПЛИТИ лівої стінки (-80.1): смугу
    # рамки біля панелі прибрано 09.07 (раніше поле обмежував її
    # торець на -78.1)
    # верх — до низу кова брови (09.07: кишені впирались у брову —
    # сліпі трикутники); брова: zb=PANEL_H-BROW_H, ków вниз на BROW_D
    field = sg.box(P.WALL_L_X + P.WALL_T, er, BR,
