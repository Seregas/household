...
def build():
    ...
    with BuildPart() as fp:
        ...
        # (21.07: фронт різу −96.45 → −96.4 = тил панелі — 0.05-кишеня
        # у тильній грані панелі в прорізі колодязя, фідбек координатою
        # 89.00/−96.45/83.42; паз поруч і так ріже з −96.4)
        with Locations(((P.LSI_X - P.LSI_WELL_HW + P.ADP_X[0]) / 2,
                        (-96.4 + -91.0) / 2, (78.0 + 89.75) / 2)):
            Box(P.ADP_X[0] - (P.LSI_X - P.LSI_WELL_HW),
                -91.0 - -96.4, 89.75 - 78.0, mode=Mode.SUBTRACT)
